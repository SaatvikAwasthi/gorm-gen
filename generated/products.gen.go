...
type IProductDo interface {
	...
	Unscoped() IProductDo
	Create(values ...*dao.Product) error
	CreateInBatches(values []*dao.Product, batchSize int) error
	Save(values ...*dao.Product) error
	First() (*dao.Product, error)
	Take() (*dao.Product, error)
	Last() (*dao.Product, error)
	Find() ([]*dao.Product, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dao.Product, err error)
	FindInBatches(result *[]*dao.Product, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dao.Product) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dao.Product, error)
	FirstOrCreate() (*dao.Product, error)
	FindByPage(offset int, limit int) (result []*dao.Product, count int64, err error)
...
func (p productDo) Create(values ...*dao.Product) error {
	if len(values) == 0 {
		return nil
	}
...
func (p productDo) CreateInBatches(values []*dao.Product, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p productDo) Save(values ...*dao.Product) error {
	if len(values) == 0 {
		return nil
	}
...
func (p productDo) First() (*dao.Product, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*dao.Product), nil
	}
}

func (p productDo) Take() (*dao.Product, error) {
...
func (p productDo) Last() (*dao.Product, error) {
...
func (p productDo) Find() ([]*dao.Product, error) {
	result, err := p.DO.Find()
	return result.([]*dao.Product), err
}

func (p productDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dao.Product, err error) {
	buf := make([]*dao.Product, 0, batchSize)
...
func (p productDo) FindInBatches(result *[]*dao.Product, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p productDo) FirstOrInit() (*dao.Product, error) {
...
func (p productDo) FirstOrCreate() (*dao.Product, error) {
...
func (p productDo) FindByPage(offset int, limit int) (result []*dao.Product, count int64, err error) {
...
func (p productDo) Delete(models ...*dao.Product) (result gen.ResultInfo, err error) {
